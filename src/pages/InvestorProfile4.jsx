...
import styles from "./InvestorProfile4.module.css";
const InvestorProfile4= () => {
  ...
  return (
    <div className={styles.investorProfile4}>
      <div className={styles.investorProfile4Child} />
      <div className={styles.investorProfile4Item} />
      <div className={styles.investorProfile4Inner} />
      ...
      <div className={styles.investorProfile4Child1} />
      ...
      <div className={styles.investorProfile4Child2} />
      <div className={styles.investorProfile4Inner1}>
        <div className={styles.boundary}>
...
export default InvestorProfile4;
